const logosHealthcare = `
    <a href="https://ariahealth.com/" 
        ...
        ">
        Aria<br><span class="text-white">Health</span>
    </a>
    ...
    <a href="https://www.virtua.org/locations/hospital-virtua-our-lady-of-lourdes" 
        ...
        ">
        Our Lady of<br>Lourdes Hospital
    </a>
    ...
    <a href="https://www.rwjbh.org/rwj-university-hospital-new-brunswick/" 
        ...
        style="
            ...
            border-radius:4px;
        ">
        R<span style="font-size:1rem;">obert</span>W<span style="font-size:1rem;">ood</span>J<span style="font-size:1rem;">ohnson</span><br><span style="font-size: 1rem; background-color:gold;padding:0.5rem 1.5rem;margin:0 -1.5rem;">University Hospital</span>
    </a>
`;
