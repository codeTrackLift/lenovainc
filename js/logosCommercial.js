const logosCommercial = `
    ...
    <a href="https://www.choicehotels.com/quality-inn" 
        target="_blank" 
        class='textShadowBlack boxShadowBig'
        style="
            line-height:1;
            color:darkgoldenrod;
    ...
    <a href="https://www.the-anchor.church/" 
        ...
        style="
            ...
            border-left:12px inset darkblue;
            border-top:12px inset darkblue;
            border-right:12px inset darkblue;
            border-bottom:12px inset darkblue;
